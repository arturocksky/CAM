//
//  TransporteCollectionViewController.swift
//  CAM
//
...
class TransporteCollectionViewController: UICollectionViewController, UIPickerViewDelegate,UIPickerViewDataSource {
    ...
    let Transporte:[String] = ["Autobus","Metrobus","Gas Estacionario","Gas Domestico","Renta","Hipoteca"]
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! TransporteCollectionViewCell
        
        // Configure the cell
        
        cell.outLabelTransporte.text = Transporte[indexPath.row]
        cell.outImageTransporte.image = UIImage(named: "\(Transporte[indexPath.row]).png")
        // Configure the cell
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let cell = collectionView.cellForItem (at: indexPath)as! TransporteCollectionViewCell
        
        let image = UIImage (named: "\(Transporte[indexPath.row])L.png")
        let w = Transporte[indexPath.row]
        
        
        let alertView = UIAlertController(
            title: Transporte[indexPath.row],
            message: "\n\n\n\n\n\n\n\n",
        ...
        let action = UIAlertAction(title: "OK", style: UIAlertActionStyle.default, handler: { (action) -> Void in
            ...
            print("Tranporte", self.Transporte[indexPath.row])
            ...
            cell.outLabelTransporte.text = "$" + String(x) + "." + String(y)
